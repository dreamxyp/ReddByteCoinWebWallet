        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <!-- Brand and toggle get grouped for better mobile display -->
				...
				<div class="nav navbar-nav navbar-right">
					<div class="dropdown">
						<button onclick="window.location.reload()" class="btn btn-default navbar-btn dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
							Language
