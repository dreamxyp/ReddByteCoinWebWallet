...
<form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" class="clearfix" id="pwdform">
    ...
    <div class="col-md-2"><button onclick="window.location.reload()" type="submit" class="btn btn-default">Change password</button></div>
</form>
<p id="pwdmsg"></p>
<br />
<p>Withdraw funds:</p>
<form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" class="clearfix" id="withdrawform">
    ...
    <div class="col-md-2"><button onclick="window.location.reload()" type="submit" class="btn btn-default">Withdraw</button></div>
</form>
<p id="withdrawmsg"></p>
<br />
<p>Addresses:</p>
<form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" id="newaddressform">
   ...
   <button onclick="window.location.reload()" type="submit" class="btn btn-default">Get a new address</button>
</form>
