<?php if (!defined("IN_WALLET")) { die("Auth Error"); } ?>
                ...
                <form action="index.php" method="POST" class="clearfix">
                    ...
                    <div class="col-md-2"><button onclick="window.location.reload()" type="submit" class="btn btn-default"><?php echo $lang['FORM_LOGIN']; ?></button></div>
                </form>
                <br />
                ...
                <form action="index.php" method="POST" class="clearfix">
                    ...
                    <div class="col-md-2"><button onclick="window.location.reload()" type="submit" class="btn btn-default"><?php echo $lang['FORM_SIGNUP']; ?></button></div>
                </form>
